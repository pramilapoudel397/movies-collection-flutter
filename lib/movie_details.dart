      ...
      torrentContainers.add(
        Container(
          ...
          child: OutlineButton(
            ...
            onLongPress: () {
              _launchURL(torrent[
                  "magnet:?xt=urn:btih:${torrent["hash"]}&dn=${title.replaceAll(" ", "+")}&tr=http://track.one:1234/announce&tr=udp://track.two:80"]);
              Clipboard.setData(ClipboardData(
                  text:
                      "magnet:?xt=urn:btih:${torrent["hash"]}&dn=${title.replaceAll(" ", "+")}&tr=http://track.one:1234/announce&tr=udp://track.two:80"));
              Toast.show("Magnet link copied to clipboard!", context,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          data["data"]["movie"]["description_intro"].toString(),
                          maxLines: 5,
